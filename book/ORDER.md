...
`book/manifest.json`이 GitHub Markdown 책, HTML 웹 교재, Notion native 계층이 공유하는 목차 기준입니다. 아래 장 번호는 **읽는 순서**이고, 기존 `docs/chNN.html` 파일명은 링크 호환성을 위해 유지합니다.

| 순서 | 부 | 장 | Markdown 장 지도 | HTML |
|---:|---|---|---|---|
| 01 | 시작하기 | 책 사용법 | [장 지도](chapters/01-이-책의-사용법.md) | [열기](../docs/ch01.html) |
| 02 | 시작하기 | 전체 커리큘럼 지도 | [장 지도](chapters/02-커리큘럼-지도.md) | [열기](../docs/ch02.html) |
| 03 | 시작하기 | 과정 개요 | [장 지도](chapters/03-과정-개요.md) | [열기](../docs/ch03.html) |
| 04 | 네트워크 | 네트워크·Cisco Packet Tracer | [장 지도](chapters/04-Cisco-Packet-Tracer-네트워크-심화.md) | [열기](../docs/ch04.html) |
| 05 | 네트워크 | 네트워크 핵심키워드 1 | [장 지도](chapters/12-핵심키워드-네트워크-1.md) | [열기](../docs/ch12.html) |
...
04장은 아래 네 원고를 순서대로 이어 읽습니다. HTML과 Notion의 Cisco 통합 학습 페이지도 같은 순서를 사용합니다.

1. [서브네팅·라우팅·RIP 수업 원문](chapters/originals/03-260813_서브네팅_라우팅_RIP_수업정리.md)
2. [네트워크 수업 완전 정리 원문](chapters/originals/01-260819_네트워크_수업_완전정리_정환주.md)
3. [Cisco Packet Tracer 실습 기록](../notes/2026-08-18_라우팅-ACL-NAT-VPN.md)
4. [네트워크 개념·공식 기준 원고](../notes/2026-08-30_네트워크-Cisco-심화-공식보강.md)

## 09장 개인과제 Lab

제공된 토폴로지·과제 요구사항을 기준으로 빈 `.pkt` 파일에서 시작합니다. 주소표와 링크 상태를 먼저 고정한 뒤 VLAN·HSRP·EIGRP·OSPF·재분배·DHCP·NAT·ACL·VPN을 단계별로 구성하고 각 단계의 `show`·ping·서비스 결과를 확인합니다.

## 원문 보존

제공받은 Markdown 5개는 원본 파일을 그대로 보관하고, 별도 HTML 페이지도 함께 생성합니다.

- [원문 보관 목차](chapters/originals/README.md)
- [공식 출처 목록](chapters/SOURCES.md)

- GitHub 확인일: 2026-08-30
- HTML 파일명은 기존 링크 호환성을 위해 유지합니다.
- 장 제목과 읽는 순서는 `book/manifest.json`에서 관리합니다.
